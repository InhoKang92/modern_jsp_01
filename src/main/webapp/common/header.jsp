 ...
 <!-- 헤더 시작 -->
    <header class="header">
        ...
        <div class="header_top">
            <h1 class="logo">
                <a href="ModernServlet?command=mdh_index">
            ...
            <div class="mall_switch">
                <ul>
                    <li>
                        <a href="ModernServlet?command=mdh_index" class="link_modern on">모던몰</a>
                    </li>
                    <li>
            ...
            <div class="top_right">
                <ul>
                    <li>
                        <a href="ModernServlet?command=mdh_login_form">
                            <img src="./img/icon_login_.png" alt="">
                            <span >로그인</span>
                        </a>
                    </li>
                    <li>
                        <a href="ModernServlet?command=mdh_join_form">
                            <img src="./img/icon_join_.png" alt="">
                            <span class="join_span">회원가입</span>
                        </a>
                    </li>
                    <li>
                        <a href="#">
        ...
        <div class="header_menu">
            ...
            <ul class="menu_right">
                ...
                <li><a href="ModernServlet?command=mdh_sub">이벤트</a></li>
